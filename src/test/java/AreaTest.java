...
public class AreaTest extends BaseTest {
    ...
    @Test
    public void scrollValuesTest() {
        SoftAssertions softAssertions = new SoftAssertions();
        mainPage.switchToAreaPage()
                .verifyPageValueElements(softAssertions);
        areaPage.verifyKM2Values(softAssertions);
        areaPage.swipeValueDown()
                .verifyHAValues(softAssertions);
